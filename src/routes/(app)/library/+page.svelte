...
<div out:fly|global={{ y: $windowHeight, duration: 400, opacity: 1 }} class='flex bg-gray-500 min-h-screen p-3 space-x-3 {!hideLoading ? 'opacity-0' : 'opacity-100'}'>
...
{#if !hideLoading}
  <div in:fly|global={{ y: $windowHeight, duration: 700, opacity: 1, easing: cubicOut }} out:fade|global={{ duration: 500 }} class='fixed top-0 left-0 z-900 w-screen h-screen flex items-center justify-center bg-gray-900'>
